...
module.exports = class Db {
  ...
  // Konstruktor: gemmer konfigurationen, så vi kan oprette forbindelse senere.
  constructor(config) {
    this.config = config;
  }

  // Hashes en email deterministisk (bruges til opslag uden at gemme ren email).
  hashEmail(email) {
  ...
  // Opretter en ny host i databasen og returnerer ID.
  async createHost({
    firstname,
    lastname,
    email,
  ...
  // Finder en host via email (matcher både klar tekst og hash).
  ...
  // Markerer om en host er 2FA-authenticated.
  ...
  // Opdaterer en host-profil og returnerer de nye felter.
  ...
  // Opdaterer password for en bruger
  ...
  // Finder en samtale mellem to værter
  ...
  // Opretter en ny samtale mellem to værter.
  ...
  // Henter alle samtaler for en vært
  ...
  // Opretter en besked og returnerer den nyeste række.
  ...
  // Henter alle beskeder i en samtale
